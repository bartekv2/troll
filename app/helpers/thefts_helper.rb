module TheftsHelper
  ...
  def get_troll
    image_tag "troll.png", style: 'height:455px; width:640px;', class: "lg:mr-16 border-2 border-white mx-auto"
  end

  def get_troll_small
    image_tag "troll_small.png", style: 'height:214px; width:300px;', class: "lg:mr-16 border-2 border-white mx-auto"
  end
